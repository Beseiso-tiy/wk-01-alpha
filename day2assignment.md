Today you're going to start styling your "" project from yesterday.  We didn't cover anything related to position, but you can start to do other styling without positioning.

- Add a new "tasks-day2.md" file with the following tasks _and then_ complete those tasks. (Remember to make small and frequent commits 😉!)
